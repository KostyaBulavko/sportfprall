...
try:
    ...
    def generate_documents():
        try:
            ...
            save_memory({f: document_blocks[0]["entries"][f].get() for f in FIELDS})
            export_to_excel()
    ...
    def launch_main_app():
        ...
        try:
            ...
            # Версія
            version_label = ctk.CTkLabel(top_frame, text="version 2.7", text_color="gray", font=("Arial", 12))
            ...
            def add_document_block(filepath=None):
                try:
                    ...
                    for field in FIELDS:
                        ...
                        # Если есть данные в памяти, вставляем их
