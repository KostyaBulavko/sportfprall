...
def create_context_menu():
    ...
    global context_menu, root
    if root is None:
         print("Помилка: root не ініціалізовано для створення контекстного меню.")
         return

    context_menu = tk.Menu(root, tearoff=0) # type: ignore # tkinter.Menu, не CTk
    ...
    context_menu.add_menu_separator()
